            ...
            <div className="hidden overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg transition-all duration-300 md:block">
              <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-6 py-3">
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">{filteredAndSorted.length}</span> customers
                </p>
                  ...
                  <tr>
                    ...
                    >
                      <div className="flex items-center">
                        Name
                        {sortConfig.key === 'name' && (
                          <svg xmlns="http://www.w3.org/2000/svg" className={`ml-1 h-4 w-4 ${sortConfig.direction === 'ascending' ? '' : 'rotate-180'}`} viewBox="0 0 20 20" fill="currentColor">
