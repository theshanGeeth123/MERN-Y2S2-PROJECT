...
export default function CustomerNotifications() {
  ...
  return (
    <>
      ...
      <div className="sm:bg-gray-50 sm:mx-30 mb-10">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="text-xl leading-none">{TYPE_ICON[n.type] || "📋"}</div>
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex flex-wrap items-start justify-between gap-2">
                          ...
                          <span className={cx("inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-medium", pill)}>
