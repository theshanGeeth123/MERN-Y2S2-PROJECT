    ...
    <div>
      ...
      <nav className="w-full flex justify-end mt-5 pr-6">
        ...
        <Link to="/admin/processed-today"
          className="px-6 py-2 bg-[#EBEBEB]  border-transparent bg-origin-border text-gradient-to-r from-slate-900 to-indigo-800 font-semibold hover:scale-105 hover:bg-[#333A5CA0] transition">
            Get Reports
        </Link>
        ...
        <Link to="/rental"
          className="px-6 py-2 bg-[#EBEBEB] border-2 border-transparent bg-origin-border text-gradient-to-r from-slate-900 to-indigo-800 font-semibold hover:scale-105 hover:bg-[#333A5CA0] transition mr-15 ">
            Add Rental Item
